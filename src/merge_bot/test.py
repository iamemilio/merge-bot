...
class test_cli(unittest.TestCase):
    def test_valid_cli_argmuents(self):
        ...
        # sanity checks
        self.assertEqual(args.source_repo, 'https://opendev.org/openstack/kuryr-kubernetes')
        self.assertEqual(args.source_branch, 'master')
        self.assertEqual(args.dest_repo, 'https://github.com/openshift/kuryr-kubernetes')
    ...
    def test_update_and_commit(self):
        ...
        try:
            ...
            self.assertEqual(str(err), "")
                ...
                self.assertTrue(repo.active_branch.is_valid(), "A commit was not made to add the changes to the repo.")
